...
class BootstrapPanelHelper extends Helper {
    ...
    **/
    ...
    /**
     * 
     * End a panel. If $title is not null, the ModalHelper::footer functions is called with $title and $options arguments.
     *
    ...
    **/
    ...
    protected function _createHeader ($title, $options = [], $titleOptions = []) {
        ...
        return $this->_cleanCurrent().$this->Html->div($class,
            $this->Html->tag('h3', $title, $titleOptions), 
            $options
        ) ; 
    }
    ...
    protected function _startPart ($part, $options = []) {
        ...
        $this->current = $part ;
        return $res.$this->Html->div('panel-'.$part.' '.$this->_extractOption('class', $options, ''), null, $options) ;
    }
    ...
    **/
    ...
    /**
     *
     * Create / Start the footer. If $buttons is specified as an associative arrays or as null, start the footer, otherwize create the footer with the specified text.
     * 
